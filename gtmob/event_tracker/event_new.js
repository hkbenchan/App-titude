	        ...
	        success: function(data, textStatus, jqXHR) {
				...
				$.each(data.date,function(key,val) {
					...
					$.each(data[i],function(key,val) {
						...
						$('#manage_list' + i).append('<li>' + val.Title + '</br><div data-role="controlgroup" data-type="horizontal" class="control_group" id="control_group_' + i + '"><a href="#admin_view_rsvps_page" data-role="button" class="unique_button" data-event="' + val.ID + '">View RSVPs</a><a href="#form_page" data-role="button" class="unique_button" data-event="' + val.ID + '">Edit</a></div></li>');
