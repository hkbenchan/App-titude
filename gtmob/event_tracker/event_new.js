		...
		$.ajax({
	        ...
	        success: function(data, textStatus, jqXHR) {
				...
				$.each(data.date,function(key,val) {
					$('#all_events_list').remove();
					$('#post_all_events').append('<div id="all_events_list"/>');
					$('#all_events_list').append('<div data-role="collapsible" class="event_collapsible" id="event_collapsible' + i + '" data-theme="b" data-content-theme="c"><h3>' + val + '</h3></div>');
