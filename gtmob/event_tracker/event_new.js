	        ...
	        success: function(data, textStatus, jqXHR) {
				...
				$.each(data.date,function(key,val) {
					...
					$.each(data[i],function(key,val) {
						...
						$('#manage_list' + i).append('<li><div data-role="controlgroup" data-type="horizontal" class="control_group" id="control_group_' + i + '"><a href="#view_event_page" data-role="button" data-event="' + val.ID + '">' + val.Title + '</a><a href="#admin_view_rsvps_page" data-role="button" data-event="' + val.ID + '">View RSVPs</a><a href="#form_page" data-role="button" data-event="' + val.ID + '">Edit</a></div></li>');
